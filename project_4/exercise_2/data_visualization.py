...
def plot_weather_data(turnstile_weather):
   ...
   However, due to the limitation of our Amazon EC2 server, we are giving you a random
    ...
    plot = ggplot(turnstile_weather, aes(x='ENTRIESn_hourly',fill='rain', color='rain')) + \
    geom_density(alpha = 0.5) + xlim(0,5000) + \
    ggtitle('Figure 2: Probability density function of hourly entries by rain') + \
    xlab("Entries hourly") + \
    ylab("Density")
    return plot
